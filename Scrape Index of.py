...
if __name__ == "__main__":
    base_url = input("Masukkan URL 'Index of': ").strip()  # Meminta input URL dari user

    if not base_url.endswith("/"):
        base_url += "/"  # Pastikan URL diakhiri dengan '/'

    with ThreadPoolExecutor(max_workers=10) as executor:  # Gunakan 10 thread
        process_directory(base_url, "", executor)
    ...
    print("Scraping selesai! Hasil disimpan di directory_list.txt")
